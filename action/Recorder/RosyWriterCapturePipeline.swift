...
//        #endif
    ...
    private func videoPipelineWillStartRunning() {
        ...
        assert(_pipelineRunningTask == UIBackgroundTaskIdentifier.invalid, "should not have a background task active before the video pipeline starts running")
    ...
    private func videoPipelineDidFinishRunning() {
        ...
        assert(_pipelineRunningTask != UIBackgroundTaskIdentifier.invalid, "should have a background task active when the video pipeline finishes running")
